    ...
    <section id="swot-roadmap" className="py-24 sm:py-32 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {swotQuadrants.map((q) => {
              ...
              return (
                <div
                  ...
                  className={`p-6 sm:p-7 rounded-3xl liquid-glass border transition-all cursor-pointer ${
                    isExpanded
        ...
        <div className="space-y-8">
          ...
          <div className="p-8 sm:p-10 rounded-3xl liquid-glass-card border border-brand-primary/30 max-w-4xl mx-auto shadow-glass-glow relative overflow-hidden">
