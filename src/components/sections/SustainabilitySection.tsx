        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {sustainabilityPillars.map((pillar) => {
            ...
            return (
              <div
                key={pillar.title}
                className="p-8 rounded-3xl liquid-glass-card border border-foreground/10 dark:border-white/10 hover:border-brand-primary/40 transition-all flex flex-col justify-between group relative overflow-hidden"
              >
                <div
