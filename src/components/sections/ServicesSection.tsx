            ...
            >
              {creativeServices.map((srv) => {
                ...
                return (
                  <div
                    key={srv.title}
                    className="p-7 rounded-3xl liquid-glass-card border border-foreground/10 dark:border-white/10 hover:border-brand-aqua/40 transition-all flex flex-col justify-between group"
                  >
            ...
            >
              {technologyServices.map((srv) => {
                ...
                return (
                  <div
                    key={srv.title}
                    className="p-8 rounded-3xl liquid-glass-card border border-foreground/10 dark:border-white/10 hover:border-brand-primary/40 transition-all flex flex-col justify-between group"
                  >
                    <div className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {investmentBreakdown.map((item) => (
              <div
                key={item.category}
                className="p-6 rounded-3xl liquid-glass border border-foreground/10 dark:border-white/10 space-y-3"
              >
