    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <motion.div
          ...
          className="absolute top-1/4 -left-32 w-96 h-96 sm:w-[520px] sm:h-[520px] rounded-full bg-brand-primary/20 dark:bg-brand-primary/25 blur-[120px]"
        />
        <motion.div
          animate={{
            x: [0, -50, 0],
          ...
          className="absolute top-1/3 -right-32 w-96 h-96 sm:w-[560px] sm:h-[560px] rounded-full bg-brand-aqua/20 dark:bg-brand-aqua/20 blur-[130px]"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[600px] h-[350px] rounded-full bg-brand-mint/15 dark:bg-brand-slate/40 blur-[140px]"
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            ...
            >
              {pillBadges.map((pill) => {
                ...
                return (
                  <div
                    key={pill.label}
                    className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-foreground/[0.04] dark:bg-white/[0.05] border border-foreground/10 dark:border-white/10 text-xs font-medium text-foreground/90 backdrop-blur-sm"
                  >
            ...
            >
              <button
                ...
                className="w-full sm:w-auto px-7 py-3.5 rounded-full bg-gradient-to-r from-brand-primary via-brand-aqua to-brand-slate text-white text-sm font-semibold shadow-[0_10px_25px_rgba(14,165,233,0.4)] hover:shadow-[0_15px_35px_rgba(14,165,233,0.55)] transition-all flex items-center justify-center gap-2 group"
              >
              ...
              <Link
                href="#layanan"
                className="w-full sm:w-auto px-7 py-3.5 rounded-full bg-foreground/[0.05] dark:bg-white/[0.06] hover:bg-foreground/[0.08] dark:hover:bg-white/[0.1] text-foreground text-sm font-semibold border border-foreground/15 dark:border-white/15 backdrop-blur-md transition-all flex items-center justify-center gap-2"
              >
          ...
          >
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-3xl p-6 sm:p-8 liquid-glass-card shadow-glass-glow border border-white/40 dark:border-brand-aqua/30 overflow-hidden group">
                ...
                <div className="relative w-full h-52 sm:h-60 my-6 rounded-2xl overflow-hidden border border-foreground/10 dark:border-white/10 shadow-inner group-hover:scale-[1.02] transition-transform duration-500">
                  <Image
                    src="/image 2.png"
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="p-3 rounded-xl bg-foreground/[0.03] dark:bg-white/[0.04] border border-foreground/10 dark:border-white/10">
